...
<html>
    <head>
        <meta charset="utf-8">
        <title>The Chumash</title>
        <style>
            body {
                background:rgb(148, 255, 153);
            }
           
            h1 {
                font-family:Arial;
                background:rgb(13, 171, 29);
                color:white;
                padding:20px;
                text-align:center;
            }
    ...
    <h1>The Chumash</h1>
    <div id="other"><h3 style="font-family:arial; color:rgb(13, 171, 29)">Other links</h3> 
        <ul>
            <li><a href="https://www.sbnature.org/collections-research/anthropology/chumash-life/">Santa Barbara Museum of Natural History</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Chumash_people">Wikipedia</a></li>
            <li><a href="http://factcards.califa.org/cai/chumash.html">Factcards</a></li>
        </ul> </div> 
    <h2>Basic Facts</h2>
    <div id="tribe">
    <p>Traditions:  Their two important traditions are basket weaving and rock art. They make the most complex baskets in North America. They can be found in museums around the world. They paint rock in their territory. <br>
    <br>

Beliefs: They believed in supernatural gods. If you are giving things to friends and family don’t expect anything in return from them unless they give something in return for you because they want to. <br>
<br>
